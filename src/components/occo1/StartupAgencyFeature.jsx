          ...
          <div className="row">
            <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-6">
              <div className="feature__content-left">
                <h2 className="sec-subtile-6">Tính năng nổi bật</h2>
                <h3 className="sec-title-6 title-anim">
                  OCCO – Mạng xã hội thế hệ mới<br />
                  Kết nối, giải trí, chia sẻ không giới hạn
                </h3>
              </div>
            </div>
            <div className="col-xxl-7 col-xl-7 col-lg-7 col-md-6">
              <div className="feature__content-right">
                <h4 className="feature__title-6">Livestream & Kết bạn</h4>
                <p>
                  Trải nghiệm livestream mượt mà, tương tác trực tiếp với bạn bè và cộng đồng OCCO. Kết nối dễ dàng, mở rộng mạng lưới bạn bè khắp mọi nơi.
                </p>
                <p>
                  OCCO giúp bạn thể hiện cá tính, xây dựng thương hiệu cá nhân và chia sẻ mọi khoảnh khắc ý nghĩa.
                </p>
                <Image
                  priority
                  width={130}
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div className="feature__content-btm">
                <div className="feature__content-item fade_bottom_4">
                  ...
                  <p>Tham gia các nhóm chat, cộng đồng sở thích, kết nối và trao đổi thông tin mọi lúc mọi nơi.</p>
                </div>
                <div className="feature__content-item fade_bottom_4">
                  <Image
                    priority
                  ...
                  />
                  <h5>
                    Chia sẻ video & bảo mật
                  </h5>
                  <p>Chia sẻ video, hình ảnh cực nhanh – OCCO luôn đảm bảo quyền riêng tư và an toàn dữ liệu cho bạn.</p>
                </div>
              </div>
            </div>
          </div>
