          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
              <div className="about__mid-7 text-anim">
                <p>
                  OCCO được tạo ra để giúp bạn kết nối, chia sẻ và tận hưởng cuộc sống số một cách trọn vẹn nhất. Chúng tôi tin rằng mỗi người đều xứng đáng có một không gian để thể hiện bản thân, gặp gỡ bạn bè mới và lan tỏa cảm hứng tích cực.
                </p>
                <p>
                  Với các tính năng livestream, chat nhóm, cộng đồng đa dạng và kho giải trí bất tận, OCCO là lựa chọn hoàn hảo cho thế hệ trẻ hiện đại muốn khám phá thế giới, xây dựng thương hiệu cá nhân và tận hưởng niềm vui mỗi ngày.
                </p>
                <Image
                  priority
                  width={155}
