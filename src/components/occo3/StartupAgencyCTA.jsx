            ...
            <div className="row">
              ...
              <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <div className="cta__content-4 text-anim">
                  <p>
                    Tải ứng dụng ngay để trải nghiệm mạng xã hội mới nhất.
                  </p>
                  <div style={{ display: "flex", gap: "24px", justifyContent: "center", marginTop: 16, flexWrap: "wrap" }}>
