              ...
              <div className="content-wrapper">
                <div className="left-content">
                  <ul className="service__list-6">
                    ...
                    <li>
                      <a href="#service_4">
                        Chia sẻ hình ảnh &<br /> Story
                      </a>
                    </li>
                    <li>
                      <a href="#service_5">
                        Khám phá<br /> Cộng đồng
                      </a>
                    </li>
                    <li>
                      <a href="#service_6">
                        Trải nghiệm<br /> mạng xã hội mới
                      </a>
                    </li>
                  </ul>
                </div>
...
<p>
  Kết nối với hàng triệu người dùng trên OCCO, mở rộng mạng lưới bạn bè, xây dựng cộng đồng của riêng bạn và khám phá những mối quan hệ ý nghĩa.
</p>
<ul>
  <li>+ Kết bạn dễ dàng</li>
  <li>+ Tìm kiếm người cùng sở thích</li>
  <li>+ Xây dựng cộng đồng riêng</li>
  <li>+ Trò chuyện mọi lúc</li>
  <li>+ Kết nối an toàn, bảo mật</li>
</ul>
                    ...
                    >
                      ...
                      <div className="animation__service_page">
                        <h2 className="service__title-6">
                          Chat nhóm & Phòng chat voice
                        </h2>
                        <p>
                          Trò chuyện cùng bạn bè, tạo nhóm, gọi voice mọi lúc mọi nơi. Chia sẻ cảm xúc, hình ảnh, video trong không gian riêng tư và an toàn.
                        </p>
                        <ul>
                          <li>+   Tạo nhóm</li>
                          <li>+ Gọi voice</li>
                    ...
                    >
                      ...
                      <div className="animation__service_page">
                        ...
                        <p>
                          Phát sóng trực tiếp, chia sẻ khoảnh khắc của bạn đến cộng đồng. Khám phá hàng ngàn video giải trí, học tập, truyền cảm hứng mỗi ngày.
                        </p>
                        <ul>
                    ...
                    >
                      ...
                      <div className="animation__service_page">
                        <h2 className="service__title-6">
                          Trải nghiệm mạng xã hội mới
                        </h2>
                        <p>
                          OCCO – mạng xã hội thế hệ mới, kết hợp các điểm mạnh của Litmatch, YouTube, Facebook, Instagram, Bogi Live,... Mang đến trải nghiệm kết nối, giải trí và chia sẻ toàn diện cho mọi người.
                        </p>
                        <ul>
                          <li>+ API Development</li>
                          <li>+ WordPress</li>
