          ...
          <div className="singlecontent">
            <div className="hover_8_wrap">
              <h2 className="tech_title fade_bottom_4" ref={hoverWrap}>
                OCCO - <Link href="/portfolio">Mạng xã hội sáng tạo</Link>
                KẾT NỐI CỘNG ĐỒNG, <Link href="/portfolio">CHIA SẺ CẢM HỨNG</Link>
                PHÁT TRIỂN BẢN THÂN
              </h2>
              <div
            ...
            <p className="single_dis pb-110 fade_bottom_4">
              OCCO là không gian để bạn kết nối, chia sẻ, sáng tạo và phát triển mỗi ngày cùng cộng đồng năng động, hiện đại.
              <br />
              Khám phá những trải nghiệm mới, lan tỏa cảm hứng và xây dựng giá trị bền vững trên nền tảng mạng xã hội thế hệ mới.
            </p>
