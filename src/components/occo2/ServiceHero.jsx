      ...
      <section className="solution__area" ref={solutionArea}>
        ...
        <div className="solution__wrapper">
          ...
          <div className="solution__mid">
            ...
            <p>
            nơi bạn có thể livestream, kết bạn, chat nhóm, chia sẻ video và tận hưởng không gian giải trí sáng tạo, an toàn, cá nhân hóa. Gia nhập cộng đồng trẻ trung, năng động và truyền cảm hứng mỗi ngày!
            </p>
          </div>
