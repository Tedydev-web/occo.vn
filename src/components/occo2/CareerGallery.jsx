          ...
          <div className="row">
            <div className="col-xxl-12">
              <ul>
                ...
                <li>Cộng đồng OCCO</li>
                <li>Vinh danh thành viên</li>
              </ul>
              <p>
                OCCO là nơi mỗi cá nhân đều có cơ hội tỏa sáng, phát triển bản thân và kết nối với hàng triệu người bạn mới. Chúng tôi tự hào về cộng đồng năng động, sáng tạo và luôn sẵn sàng sẻ chia, hỗ trợ lẫn nhau. Mỗi khoảnh khắc, mỗi thành viên đều góp phần xây dựng nên một mạng xã hội hiện đại, nhân văn và đầy cảm hứng.
              </p>
            </div>
          </div>
