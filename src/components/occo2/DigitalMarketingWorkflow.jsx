                  ...
                  <div className="research__list">
                    <div className="research__item">
                      ...
                      <div className="research__info">
                        <h4 className="research__title">Kết nối cộng đồng</h4>
                        <p>
                          90% người dùng OCCO cảm thấy dễ dàng kết bạn và mở rộng mối quan hệ xã hội.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="research__item">
                      ...
                      <div className="research__info">
                        <h4 className="research__title">Bảo mật & riêng tư</h4>
                        <p>
                          99% người dùng hài lòng với khả năng bảo vệ thông tin cá nhân và quyền riêng tư trên OCCO.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="research__item">
                      ...
                      <div className="research__info">
                        <h4 className="research__title">Đa dạng nội dung</h4>
                        <p>
                          85% người dùng yêu thích kho nội dung phong phú: livestream, video, story, chat nhóm, sự kiện cộng đồng...
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                  <div className="counter__wrapper-3">
                    <div className="counter__item-3">
                      <h2 className="counter__number count1">1M+</h2>
                      <p>
                        Người dùng <br />
                        hoạt động
                      </p>
                    ...
                    <div className="counter__item-3">
                      <h2 className="counter__number count2">500k+</h2>
                      <p>
                        Kết nối <br />
                        mỗi ngày
                      </p>
                    ...
                    <div className="counter__item-3">
                      <h2 className="counter__number count3">50+</h2>
                      <p>
                        Sự kiện <br />
                        nổi bật
                      </p>
                    ...
                    <div className="counter__item-3">
                      <h2 className="counter__number count4">24/7</h2>
                      <p>
                        Hỗ trợ <br />
                        tận tâm
                      </p>
                ...
                <div className="col-xxl-12">
                  <div className="cta__content-3">
                    ...
                    <h2 className="cta__title-2">
                      Tham gia OCCO ngay hôm nay để khám phá thế giới mạng xã hội mới mẻ, hiện đại và đầy cảm hứng!
                    </h2>
                    <div className="btn_wrapper">
                      ...
                      >
                        <span></span>Đăng ký <br />
                        ngay <i className="fa-solid fa-arrow-right"></i>
                      </Link>
                    </div>
                  </div>
                </div>
