        ...
        <div className="offcanvas__body">
          <div className="offcanvas__left">
            ...
            <div className="offcanvas__links">
              <ul>
                <li>
                  <Link href="/occo3/terms">Điều khoản sử dụng</Link>
                </li>
                <li>
                  <Link href="/occo3/privacy">Chính sách bảo mật</Link>
                </li>
                <li>
                  <Link href="/occo3/legal">Pháp lý</Link>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="offcanvas__menu-wrapper">
              <nav className="offcanvas__menu">
                <ul className="menu-anim title" ref={headerTitle}>
                  <li>
                    <div className="header_title hto">
                      <Link href={"/occo3"}>Trang chủ</Link>
                    </div>
                  </li>
                  <li>
                    <div className="header_title hto">
                      <Link href={"/occo3/about"}>Giới thiệu</Link>
                    </div>
                  </li>
                  <li>
                    <div className="header_title hto">
                      <Link href={"/occo3/blog"}>Blog</Link>
                    </div>
                  </li>
                  <li>
                    <div className="header_title hto">
                      <Link href={"/occo3/faq"}>FAQ</Link>
                    </div>
                  </li>
                  <li>
                    <div className="header_title hto">
                      <Link href={"/occo3/contact"}>Liên hệ</Link>
                    </div>
                  </li>
                </ul>
              </nav>
